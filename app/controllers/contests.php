...
EOD;
		...
		echo '<td>', '<a href="'.HTML::timeanddate_url($contest['start_time'], array('duration' => $contest['last_min'])).'">'.$contest['end_time']->format("Y-m-d H:i:s").'</a>', '</td>';
...
<?php
	...
	$table_header .= '<th style="width:15em;">'.UOJLocale::get('contests::end time').'</th>';
