<?php
	...
	$comment_form->handle = function() {
		...
		list($comment, $referrers) = uojHandleAtSign($comment, "/blog/".UOJContext::user()['username']."/blog/{$blog['id']}");
	...
	<div id="comment-<?= $comment['id'] ?>" class="list-group-item">
		<div class="media">
			...
			<div id="comment-body-<?= $comment['id'] ?>" class="media-body comtbox">
				...
				<ul class="text-right list-inline bot-buffer-no"><li><small class="text-muted"><?= $comment['post_time'] ?></small></li>
