...
<div class="row">
	<div class="col-md-3">
		...
		<div class="btn-group btn-group-justified">
			<a href="/blog/<?= UOJContext::user()['username'] ?>/blog/new/write" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span> 写新博客</a>
			<a href="/blog/<?= UOJContext::user()['username'] ?>/slide/new/write" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span> 写新幻灯片</a>
		</div>
		<?php endif ?>
