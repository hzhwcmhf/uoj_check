...
<form id="form-register" class="form-horizontal">
	...
	<div id="div-username" class="form-group">
		<label for="input-username" class="col-sm-2 control-label">学号（选课同学）<br />用户名（非选课同学）</label>
		<div class="col-sm-3">
			<input type="text" class="form-control" id="input-username" name="username" placeholder="输入用户名或学号（例如2017011000）" maxlength="20" />
